...
# 
spr_tmp<- rast("data/spr_tmp_nc.tif")

extract(x = spr_tmp,
        y = sf_site)
 
# ENTER YOUR ANSWER HERE: 22
...
sf_buff_proj <- project(x = sf_site_four_buff,
        y = crs(sf_site_four_buff,
                method = "bilinear"))
